...
namespace FileManager
{
    public partial class Main : Form
    {
        ...
        private void FileListView_KeyDown(object sender, KeyEventArgs e) // FileListView 키보드 이벤트 
        {
            ...
            else if (e.KeyCode == Keys.F5) Refresh_FileList();
        }
        private void FileListView_MouseDown(object sender, MouseEventArgs e) // FileListView 클릭 이벤트 
        {
            ...
            else if (e.Button == MouseButtons.Right && FileListView.SelectedItems.Count == 0 && FolderPath != null)
            {
            ...
            else if (e.Button == MouseButtons.Right && FileListView.SelectedItems.Count == 1)
            {
